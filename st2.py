...
image = st.file_uploader("Escolha uma imagem", type= ["png", "jpeg", "jpg"])
...
font_size2 = st.number_input("Escolhe o tamanho da fonte", min_value= 10, max_value= 20, value = 20)
if image:
    ...
    if result:
        ...
        with open("image.png", 'rb') as f:
            st.download_button("Baixar imagem", f)